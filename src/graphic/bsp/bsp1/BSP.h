...
public:
	...
	// GLuint * decalTextures; // #TODO
	//did the textures load?
	// bool * isTextureLoaded; // #TODO
	...
	// GLuint * lightmapTextures; // #TODO
	// GLuint whiteTexture;	//used if no lightmap specified // #TODO
	...
	BSP() : numVertices(0), vertices(NULL),
			...
			// numTextures(0), decalTextures(NULL), // #TODO
