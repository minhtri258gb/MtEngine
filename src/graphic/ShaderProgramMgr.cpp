...
void ShaderProgramMgr::init() {
	...
	// Simple Model
	SimpleModel::shader.init("mdlSimple",
	...
	// Color Model
	ColorModel::shader.init("mdlColor",
		ShaderProgram::SHADER_TYPE::VERTEX |
		ShaderProgram::SHADER_TYPE::FRAGMENT);
	...
	// Animation Model
	AnimationModel::shader.init("skinning",
		ShaderProgram::SHADER_TYPE::VERTEX |
		ShaderProgram::SHADER_TYPE::FRAGMENT);
	...
	// BspQuakeMap
	BspQuakeMap::shader.init("bsp_quake",
		ShaderProgram::SHADER_TYPE::VERTEX |
		ShaderProgram::SHADER_TYPE::FRAGMENT);
